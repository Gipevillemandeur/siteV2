    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-md p-6">
          ...
          <iframe
            id="haWidget"
            src="https://www.helloasso.com/associations/groupement-independant-de-parents-d-eleves-du-college-de-villemandeur/adhesions/adhesion-gipe-villemandeur/widget-vignette"
